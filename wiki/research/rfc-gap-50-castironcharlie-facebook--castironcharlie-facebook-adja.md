---
title: "RFC: GAP-50--castironcharlie-facebook - **CastIronCharlie-Facebook (adjacent-topics - Tracking Heavy Fixtures"
category: "research"
topic: "rfc-gap-50-castironcharlie-facebook--castironcharlie-facebook-adja"
gap_id: "GAP-50--castironcharlie-facebook"
status: "draft"
created_at: "2026-09-19T20:51:14.105Z"
expansion_method: "heuristic"
retrieval_mode: "hybrid-rrf"
ast_grounded_symbols: ["scripts/notebooklm/ingest-notebooklm.sh"]
citations: ["wiki/research/rfc-gap-02--castironcharlie-facebook-adja.md","wiki/research/rfc-gap-18-cic-kb--cic-kb-adjacent-topics-real-t.md","docs/kb/notebooklm-sync/pipeline.md"]
---

# RFC: GAP-50--castironcharlie-facebook - **CastIronCharlie-Facebook (adjacent-topics - Tracking Heavy Fixtures

## 1. Problem Statement & Context
)**: **Tracking Heavy Fixtures:** The tabulating system tracked **40 center-wing fixtures weighing 27.5 tons each** (a combined fixture mass equal to 37 M-4 tanks) to maintain real-time
...
- **rfc-gap-02--castironcharlie-facebook-adja** (`wiki/research/rfc-gap-02--castironcharlie-facebook-adja.md`) [hybrid]:
  > 
- **rfc-gap-18-cic-kb--cic-kb-adjacent-topics-real-t** (`wiki/research/rfc-gap-18-cic-kb--cic-kb-adjacent-topics-real-t.md`) [lexical_only]:
  > 

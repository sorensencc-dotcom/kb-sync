...
- Treat `wiki/research/rfc-gap-01--cic-kb-follow-up.md` as the canonical GAP-01 CIC-KB follow-up note. Do not regenerate it from a paren-padded truncated gap line.
...
- [ ] How many other `trm-research-gaps.md` rows and RFC problem statements used the same mid-token parenthesis pad, and should they be rewritten the same way?

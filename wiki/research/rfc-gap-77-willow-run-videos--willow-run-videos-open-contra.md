---
title: "RFC: GAP-77--willow-run-videos - **Willow Run Videos (open-contradictions - No source found for the 1943 production date.)**"
category: "research"
topic: "rfc-gap-77-willow-run-videos--willow-run-videos-open-contra"
gap_id: "GAP-77--willow-run-videos"
status: "draft"
created_at: "2026-09-19T20:28:51.350Z"
expansion_method: "heuristic"
retrieval_mode: "hybrid-rrf"
ast_grounded_symbols: []
citations: ["wiki/research/rfc-gap-02--willow-run-videos-open-contra.md","wiki/research/rfc-gap-02--willow-run-videos-adjacent-to.md","wiki/research/rfc-gap-04--willow-run-videos-open-contra.md"]
---

# RFC: GAP-77--willow-run-videos - **Willow Run Videos (open-contradictions - No source found for the 1943 production date.)**

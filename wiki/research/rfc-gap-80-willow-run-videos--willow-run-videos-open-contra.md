---
title: RFC: GAP-80--willow-run-videos - **Willow Run Videos (open-contradictions - Rivet Counts
category: research
topic: rfc-gap-80-willow-run-videos--willow-run-videos-open-contra
gap_id: GAP-80--willow-run-videos
status: draft
created_at: 2026-09-19T20:41:05.143Z
expansion_method: heuristic
retrieval_mode: hybrid-rrf
ast_grounded_symbols: ["scripts/notebooklm/ingest-notebooklm.sh"]
citations: ["wiki/research/.catalog.json","wiki/research/rfc-gap-03--castironcharlie-facebook-unde.md","docs/kb/notebooklm-sync/pipeline.md"]
sourceRepository: kb-sync
---

# RFC: GAP-80--willow-run-videos - **Willow Run Videos (open-contradictions - Rivet Counts

## 1. Problem Statement & Context
)**: **Rivet Counts:** Figures vary from **360,000 rivets** [28] to **550,000 rivets** [26], **700,000 rivets** [29], **750,000 rivets** [30], and **1.25 million rivets** [25].

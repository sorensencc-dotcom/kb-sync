---
title: "RFC: GAP-85--willow-run-videos - **Willow Run Videos (under-sourced - John Dodge's Office Slap"
category: "research"
topic: "rfc-gap-85-willow-run-videos--willow-run-videos-under-sourc"
gap_id: "GAP-85--willow-run-videos"
status: "draft"
created_at: "2026-09-19T21:02:40.259Z"
expansion_method: "heuristic"
retrieval_mode: "hybrid-rrf"
ast_grounded_symbols: []
citations: ["wiki/research/rfc-gap-18-willow-run-videos--willow-run-videos-adjacent-to.md","wiki/research/rfc-gap-26-willow-run-videos--willow-run-videos-adjacent-to.md","wiki/research/.catalog.json"]
---

# RFC: GAP-85--willow-run-videos - **Willow Run Videos (under-sourced - John Dodge's Office Slap

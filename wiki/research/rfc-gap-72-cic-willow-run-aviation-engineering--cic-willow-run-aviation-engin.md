---
title: "RFC: GAP-72--cic-willow-run-aviation-engineering - **CIC - Willow Run & Aviation Engineering (under-sourced - Contradictory Memoirs"
category: "research"
topic: "rfc-gap-72-cic-willow-run-aviation-engineering--cic-willow-run-aviation-engin"
gap_id: "GAP-72--cic-willow-run-aviation-engineering"
status: "draft"
created_at: "2026-09-19T21:06:14.083Z"
...
# RFC: GAP-72--cic-willow-run-aviation-engineering - **CIC - Willow Run & Aviation Engineering (under-sourced - Contradictory Memoirs

## 1. Problem Statement & Context
)**: **Contradictory Memoirs:** First-person retrospective memoirs by production chief Charles Sorensen (*My Forty Years with Ford*) and security chief Harry Bennett (*We Never Called H

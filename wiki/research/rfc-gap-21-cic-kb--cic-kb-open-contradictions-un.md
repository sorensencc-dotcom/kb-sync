...
**Unpackaged CLI Distribution**: The Sigil CLI is executed via raw Node paths (`node sigil/cli/sigil.mjs`) without a scoped `package.json` or binary mapping (`bin` entry) [1, 2, 22

...
citations: ["wiki/research/rfc-gap-01--willow-run-videos-follow-up.md","trm-research-gaps.md","wiki/research/rfc-gap-01--cic-kb-follow-up.md"]
---

# RFC: GAP-01 - **Willow Run Videos (follow-up)**

## 1. Problem Statement & Context
Recent investigation into **Albert Kahn's L-Bend** successfully demystified the architectural and tax battle of the county line, proving that airp. Follow-up research should pin primary sources, dates, and unresolved claims before those leads enter the documentary record.

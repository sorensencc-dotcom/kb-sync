---
title: RFC: GAP-106--willow-run-videos - **Willow Run Videos (open-contradictions - Rivet Counts
category: research
topic: rfc-gap-106-willow-run-videos--willow-run-videos-open-contra
gap_id: GAP-106--willow-run-videos
status: draft
created_at: 2026-09-19T20:59:11.778Z
...
# RFC: GAP-106--willow-run-videos - **Willow Run Videos (open-contradictions - Rivet Counts

## 1. Problem Statement & Context
)**: **Rivet Counts:** Figures fluctuate between **360,000 rivets** [40], **550,000 rivets** [43], **700,000 rivets**, and **1.25 million rivets** [41, 45].

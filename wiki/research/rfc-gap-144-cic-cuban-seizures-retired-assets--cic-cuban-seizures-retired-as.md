---
title: RFC: GAP-144--cic-cuban-seizures-retired-assets - **CIC - Cuban Seizures & Retired Assets (open-contradictions - **Ford's Cuban Subsidiary (*Credesco* — Claim C...)**
category: research
topic: rfc-gap-144-cic-cuban-seizures-retired-assets--cic-cuban-seizures-retired-as
gap_id: GAP-144--cic-cuban-seizures-retired-assets
status: draft
created_at: 2026-09-19T21:04:43.974Z
expansion_method: heuristic
retrieval_mode: hybrid-rrf
ast_grounded_symbols: ["scripts/notebooklm/ingest-notebooklm.sh"]
citations: ["wiki/research/rfc-gap-07-cic-kb--cic-kb-follow-up-fcsc-cuban-c.md","docs/kb/notebooklm-sync/pipeline.md","wiki/research/rfc-gap-03--cic-cuban-seizures-retired-as.md"]
sourceRepository: kb-sync
---

# RFC: GAP-144--cic-cuban-seizures-retired-assets - **CIC - Cuban Seizures & Retired Assets (open-contradictions - **Ford's Cuban Subsidiary (*Credesco* — Claim C...)**

## 1. Problem Statement & Context
**Ford's Cuban Subsidiary (*Credesco* — Claim CU-3072):** The FCSC adjusted Credesco's book net worth from \$216,334.12 down to **\$169,046.42** (deducting an inter-company account

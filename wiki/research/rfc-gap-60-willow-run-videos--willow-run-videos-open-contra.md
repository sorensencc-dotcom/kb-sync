---
title: RFC: GAP-60--willow-run-videos - **Willow Run Videos (open-contradictions - The Consensus
category: research
topic: rfc-gap-60-willow-run-videos--willow-run-videos-open-contra
gap_id: GAP-60--willow-run-videos
status: draft
created_at: 2026-09-19T20:40:16.462Z
expansion_method: heuristic
retrieval_mode: hybrid-rrf
ast_grounded_symbols: []
citations: ["trm-research-gaps.md","wiki/research/rfc-gap-02--willow-run-videos-adjacent-to.md","wiki/research/rfc-gap-04--willow-run-videos-open-contra.md"]
sourceRepository: kb-sync
---

# RFC: GAP-60--willow-run-videos - **Willow Run Videos (open-contradictions - The Consensus

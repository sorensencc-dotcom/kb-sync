---
title: schedule-task-wrapper-KB-Sync-Master.ps1
category: utilities
status: active
...
## Overview
Synthesized entity documentation for `scripts/schedule-task-wrapper-KB-Sync-Master.ps1` in **kb-sync-drift-fix**.

# Auto-generated wrapper for KB-Sync-Validate-Staging
...
$LogFile = Join-Path $LogDir "KB-Sync-Validate-Staging-20260720-232323.log"
$StartTime = Get-Date

"
=== KB-Sync-Validate-Staging ===" | Tee-Object -FilePath $LogFile -Append
...
try {
    ...
    & cmd /c "npm run wiki:validate-staging" 2>&1 | Tee-Object -FilePath $LogFile -Append

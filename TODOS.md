...
- [ ] **[P2] kb-sync documentation drift remediation (batch)** (created 2026-08-30) — 7 sibling wiki file(s) out of sync with code changes across workspace. Run wiki synthesis to regenerate.

- [ ] **[P2] kb-sync documentation drift remediation (batch)** (created 2026-08-29) — 1 sibling wiki file(s) out of sync with code changes across workspace. Run wiki synthesis to regenerate.
